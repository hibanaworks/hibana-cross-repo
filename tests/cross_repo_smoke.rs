...
fn manifest_default_lane_tracks_exact_git_revs() {
    ...
    assert!(cargo_toml.contains("rev = \"a889e00c3a48a90c7884501dccae488a46e94df3\""));
...
fn lockfile_pins_resolved_git_sources() {
    ...
    assert!(cargo_lock.contains(
        "source = \"git+https://github.com/hibanaworks/hibana-mgmt?rev=a889e00c3a48a90c7884501dccae488a46e94df3#a889e00c3a48a90c7884501dccae488a46e94df3\""
    ));
    assert!(cargo_lock.contains(
